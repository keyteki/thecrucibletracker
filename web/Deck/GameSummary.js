...
class GameSummary extends React.Component {
    render() {
        const { game, deckID, user, isMobile } = this.props;
            ...
            >
                ...
                >
                    ...
                    {!isMobile ? (
                        <>
                            {opponent === 'anonymous' ? (
                                <span style={{ margin: '5px 0', marginLeft: '0.75rem' }}>
                                    anonymous
                                </span>
                            ) : (
                                <a
                            ...
                            {!isVictory ? (
                                <a
                                    ...
                                    target='_blank'
                                    href={`https://www.keyforgegame.com/deck-details/${game.winner_deck_id}`}
                                    rel='noreferrer'
                                >
                                ...
                                <a
                                    ...
                                    target='_blank'
                                    href={`https://www.keyforgegame.com/deck-details/${game.loser_deck_id}`}
                                    rel='noreferrer'
                                >
                        ...
                        >
                            {`versus "${
                                !isVictory ? game.winner_deck_name : game.loser_deck_name
                            }"`}
                        </a>
                    )}
                    {!isMobile && (
