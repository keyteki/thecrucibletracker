...
const Leaderboard = ({
  name, decks, previousVersion, isMobile
}) => (
  <div>
    <div style={{
      fontSize: '26px',
    ...
    >
      <div>
        {name}
        <Tooltip title="Data from last 6 months for decks with 40+ games. Noted changes in elo cover the last 24 hours of play. Updates every 10 minutes." arrow style={{ margin: '0 0 0 0.5rem' }}>
                  ...
                  <div style={{ display: 'flex' }}>
                    <div style={{ marginRight: '3rem' }}>
                      ...
                      <div>
                        { deck.elo }
                        { previous && (
                          <span style={{ fontSize: '12px', marginLeft: '0.25rem', color: previousColor }}>
        ...
        return (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              {deck.player === 'anonymous' ? <div>{deck.player}</div>
                : <Link newTab text={deck.player} url={`/users/${deck.player}/decks/${deck.deckID}`} />}
            </div>
            <div style={{ marginLeft: '1.5rem', marginTop: '0.5rem' }}>
              ...
              <div style={{ width: '140px' }}>{`Record: ${deck.wins} - ${deck.losses}`}</div>
            </div>
          </div>
        );
      }
