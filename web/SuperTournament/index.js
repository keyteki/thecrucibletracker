                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                An invite-only Bo3 Archon Solo event for top ranked players on The
                                Crucible Tracker's leaderboard.
                            </div>
                            <div>
                                <Link
                                    newTab
                                ...
                                >
                                    <div>
                                        <Link
                                            ...
                                            style={{
                                                fontSize: '20px',
                                                textDecoration: playerRanks[1].alive
                                                    ? ''
                                                    : 'line-through',
                                ...
                                >
                                    <div>
                                        <Link
                                            ...
                                            style={{
                                                fontSize: '20px',
                                                textDecoration: playerRanks[4].alive
                                                    ? ''
                                                    : 'line-through',
                                ...
                                >
                                    <div>
                                        <Link
                                            ...
                                            style={{
                                                fontSize: '20px',
                                                textDecoration: playerRanks[3].alive
                                                    ? ''
                                                    : 'line-through',
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div style={{ fontSize: '16px', marginTop: '0.5rem' }}>
                                        <div>{`${player.elo} elo`}</div>
                                        <div
                                            style={{ marginTop: '0.5rem' }}
                                        >{`${player.wins} wins - ${player.losses} losses`}</div>
                                    </div>
                                </div>
                                <a
                                    href={`https://keyforgegame.com/deck-details/${player.deckID}`}
                                    target='_blank'
                                    rel='noreferrer'
                                >
                                    <Deck
