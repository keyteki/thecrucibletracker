...
class Screen extends Component {
    ...
    componentDidMount(prevProps, prevState, snapshot) {
        const fetchSummary = () => {
            fetch('/api/summary')
                ...
                .then(({ recentGames, totalGames, gamesInSets, gamesLast7Days }) => {
                    this.setState({
                        recentGames,
                        totalGames,
                        gamesLast7Days,
    ...
    render() {
        const { recentGames, totalGames, gamesLast7Days, gamesInSets } = this.state;
        ...
        return (
            ...
            >
                ...
                <HeadlineContainerDesktop width={isMobile ? 'unset' : undefined}>
                    <Headline>Track your KeyForge data</Headline>
                    <Description>
                    ...
                    <MainButtons>
                        <SecondaryLink href='/users/Ugluk4242'>Example Data</SecondaryLink>
                    </MainButtons>
