...
class UserIcon extends Component {
    ...
    render() {
        const { user, alignRight } = this.props;
        ...
        return (
            <UserContainer
                padding={alignRight ? '0.5rem 0 0.5rem 0.5rem' : '0.5rem 0.5rem 0.5rem 0'}
            >
                {alignRight ? (
                    <>
                        {name}
    ...
    render() {
        ...
        const gameElements = games.map((game) => {
            ...
            if (game.winner === 'anonymous') {
                winner = <UserIcon user='anonymous' level={1} progress={0} />;
            }

            if (game.loser === 'anonymous') {
                loser = <UserIcon user='anonymous' level={1} progress={0} alignRight={!isMobile} />;
            }
            ...
            return (
                ...
                >
                    {isMobile ? (
                        ...
                        <>
                            <div style={{ width: '45%', overflow: 'hidden' }}>{winner}</div>
                            <div
