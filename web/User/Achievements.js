...
class Achievements extends Component {
    ...
    render() {
        const { achievements, loaded } = this.state;
            ...
            <div>
                <div style={{ margin: '10px' }}>
                    <div style={{ display: 'flex', width: 'fit-content', alignItems: 'center' }}>
                        <div style={{ fontSize: '20px', userSelect: 'none', marginRight: '5px' }}>
                            Achievements
                        </div>
                    </div>
                </div>
                            ...
                            ({
                                ...
                                return (
                                    <Achievement
                                        title={title}
                                        progress={
                                            progress !== 0 && date_awarded_on == null
                                                ? progress
                                                : null
                                        }
                                        percentage={
                                            progress !== 0
                                                ...
                                                : date_awarded_on == null
                                                ? 0
                                                : 100
                                        }
                                        globalCompletion={
                                            globalCompletion < 1
                                                ? globalCompletion.toFixed(1)
                                                : globalCompletion.toFixed(0)
                                        }
                                        showCount={showCount}
                                        isMobile={isMobile}
