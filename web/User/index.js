...
const UserIcon = (props) => {
    const { user, progress, loaded } = props;
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {loaded && <img src={getS3Image(level.image)} style={level.style} />}
                    </div>
                </div>
...
class UserScreen extends Component {
    ...
    componentDidMount(prevProps, prevState, snapshot) {
        ...
        fetchData(this.props.user).then(({ games }) => {
            this.setState({
                games,
                loaded: true
            });
    ...
    render() {
        ...
        const { games, awards, loaded } = this.state;
        let { userLevel, userProgress } = this.state;
                ...
                <Content>
                    {isAnonymous && (
                        <div style={{ margin: '2rem 1rem' }}>
                            <div>No data is available for this user</div>
                            <br />
                            <div>
                                {'To record data, install the '}
                                <a href='https://chrome.google.com/webstore/detail/crucible-tracker/kofdhlbkhmcjaknedcblchhmlilmfadk?hl=en'>
                                    Crucible Tracker
                                </a>
                                {' Chrome extension'}
                            </div>
                    ...
                    {!isAnonymous && (
                        <>
                            <Games awards={awards} games={games} user={user} isMobile={isMobile} />
                            <br />
